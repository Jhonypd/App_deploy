...
/// </summary>
public sealed class IisSiteManager : IIisSiteManager
{
	#region Public Methods
	/// <summary>
	/// Para o site e o application pool quando estiverem em execução.
	/// </summary>
	...
	/// <summary>
	/// Inicia o site e o application pool associado.
	/// </summary>
	...
	/// <summary>
	/// Aguarda até o site atingir o estado esperado.
	/// </summary>
	...
	/// <summary>
	/// Aguarda até o application pool atingir o estado esperado.
	/// </summary>
