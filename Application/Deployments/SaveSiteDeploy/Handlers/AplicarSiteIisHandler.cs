...
public class AplicarSiteIisHandler : ICommandHandler<AplicarSiteIisCommand, Task<bool>>
{
    private readonly ISiteDeployRepository _repository;
    private readonly IIisSiteManager _iisManager;

    public AplicarSiteIisHandler(ISiteDeployRepository repository, IIisSiteManager iisManager)
    {
        _repository = repository;
        _iisManager = iisManager;
    }

    public async Task<bool> Handle(AplicarSiteIisCommand command)
    {
